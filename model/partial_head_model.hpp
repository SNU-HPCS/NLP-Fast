#ifndef MODEL_PARTIAL_HEAD_MODEL_HPP
#define MODEL_PARTIAL_HEAD_MODEL_HPP
...
//////////////////////
/// self_attention_partial_head
//////////////////////
class self_attention_partial_head{
private:
	Params *params;
...
public:
	self_attention_partial_head(Params *_params, BERT_State *bert_state, int layer_idx, bool _is_training);
	void dump_values();
...
//////////////////////
/// transformer_encoder_partial_head
//////////////////////
class transformer_encoder_partial_head{
private:
	Params *params;
	bool is_training;
	int batch;
	...
	self_attention_partial_head *attention_layer;
...
public:
	transformer_encoder_partial_head(Params *_params, BERT_State *bert_state, int layer_idx, bool _is_training);
	void dump_values();
...
private:
	...
	embedding *embedding_layer;
	transformer_encoder_partial_head **transformer_layer;
	layer_dense *pooler;
...
#endif //MODEL_PARTIAL_HEAD_MODEL_HPP
